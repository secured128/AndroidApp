 ...
 * 
 */
public class ParametrizerMixed1 extends ParametrizerAbstract {
	...
	public DecryptedParameters getParameters(byte[] byteArray) {
		long encryptorId = JcryptManager.getLongParamFromReversedAndCompressedWithLengthByteArrayStart(byteArray);
